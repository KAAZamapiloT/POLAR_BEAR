...
// IF DOOR CAN BE UNLOCKED THIS FUNCTION WILL UNLOCK THE DOOR ID DOOR IS NORMAL ONLY THEN IT CAN BE ONLOCKED WITH MASTER KEY AND THERE IS ONLY ONE MASTER KEY IN WHOLE GAME
void AADoor::RevCast()
{
